...
class _$UserTearOff {
  ...
  _User call(
      String userID, String name, String urlAvatar, String lastMessageTime) {
    return _User(
      userID,
      name,
      urlAvatar,
...
class _$_User with DiagnosticableTreeMixin implements _User {
  const _$_User(this.userID, this.name, this.urlAvatar, this.lastMessageTime);
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'User(userID: $userID, name: $name, urlAvatar: $urlAvatar, lastMessageTime: $lastMessageTime)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('urlAvatar', urlAvatar))
...
abstract class _User implements User {
  const factory _User(String userID, String name, String urlAvatar,
      String lastMessageTime) = _$_User;
